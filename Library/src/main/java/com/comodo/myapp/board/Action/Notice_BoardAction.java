package com.comodo.myapp.board.Action;
...
import com.comodo.myapp.board.service.Notice_BoardServiceImpl;

//컨트롤러!
@Controller
public class Notice_BoardAction {
	...
	@Autowired
	private Notice_BoardServiceImpl boardService;
	...
	public String board_write_ok(@ModelAttribute Notice_BoardBean board)
			throws Exception {
...
//			throws Exception {
	...
	public ModelAndView board_cont(@RequestParam("board_num") int board_num,
		...
		Notice_BoardBean board = boardService.board_cont(board_num);
	...
	public String board_edit_ok(@ModelAttribute Notice_BoardBean b,
		...
		if (result == 0) {
			...
			return "redirect:/board_cont.nhn?board_num=" + b.getN_num()
...
//	public String board_reply_ok(@ModelAttribute Notice_BoardBean b,
